...
export default function SlackGroup({img, name, description, link}) {
      ...
      <div className="grid grid-cols-8 md:grid-cols-12">
        <div className="col-span-1">
          <div className="w-full relative">
            ...
            <div className="inline-block h-6 w-6 bg-white border rounded-full p-1 absolute -right-2 -bottom-2">
